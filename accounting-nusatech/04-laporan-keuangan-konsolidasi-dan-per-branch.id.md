...
description: Laba Rugi, Neraca, Arus Kas PT NUSATECH (1 branch) — dan gap tidak-ada-breakdown-otomatis per Business Unit di endpoint laporan.
visibility: internal
---

# 04. Laporan Keuangan & Breakdown per Business Unit

> **Nama file dipertahankan** (`...-konsolidasi-dan-per-branch.id.md`) untuk menjaga referensi silang lintas suite tetap utuh — isi di bawah SUDAH direvisi total. Sebelumnya file ini menguji "konsolidasi 2 branch"; sekarang **tidak ada lagi konsolidasi lintas-branch sama sekali** (PT NUSATECH cuma 1 branch, jadi 1 kali panggil laporan sudah otomatis mencakup semuanya). Yang tersisa relevan dari konsep lama adalah **breakdown per divisi (Business Unit)** — dan itu TETAP manual, bukan fitur laporan siap pakai.
>
...
## 1. Laba Rugi PT NUSATECH (`POST reports/income-statement`)
...
## 2. Neraca PT NUSATECH (`POST reports/balance-sheet`)
...
## 3. Arus Kas PT NUSATECH (`POST reports/cash-flow-statement`)
