---
title: (Manufaktur) — Varian 2 — 01. Jurnal Manual, Arus Biaya Produksi & Pinjaman Bank
...
Transaksi: beli bahan baku dari CV Botol Prima Sentosa senilai Rp 40.000.000 + PPN 11% (Rp 4.400.000), tunai dari BCA Operasional.
...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------: |
| AST-02 BCA Operasional        | 200.000.000 − 44.400.000 − 28.500.000 − 12.000.000 − 5.000.000 − 30.000.000 − 250.000.000 − 6.500.000 = **-176.400.000** ⚠️ lihat catatan di bawah |
...
| Positif — suntikan modal tambahan          | **WAJIB sebelum lanjut file 02/06**: `lines:[{AST-02, debit:200000000},{EKT-01, credit:200000000}]`, `date:"2026-01-31"`  | Saldo AST-02 akhir jadi **23.600.000** — kalau langkah ini terlewat, seluruh angka BCA Operasional di file 02/06 akan meleset              |

## Referensi Silang

- [`../accounting-manufaktur/01-jurnal-manual-arus-biaya-produksi-dan-pinjaman.id.md`](../accounting-manufaktur/01-jurnal-manual-arus-biaya-produksi-dan-pinjaman.id.md) — file setara di suite manufaktur varian 1 (CV Sumber Makmur Abadi), kasus identik dengan perusahaan berbeda; bandingkan hasil kalau ada penyimpangan tak terduga
